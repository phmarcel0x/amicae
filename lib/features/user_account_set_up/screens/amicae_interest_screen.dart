              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20),
                    // ... (rest of the category building code remains the same)
                    // The existing buildCategory method and categories remain unchanged
                    // ... (all previous category building code)
                    SizedBox(height: 50),
                  ],
                ),
              ),
